...
mpiexec -n $procs ./openmpi ../resources/a100x10.txt ../resources/b10x100.txt
printf "\n\n"
...
mpiexec -n $procs ./openmpi ../resources/a100x100.txt ../resources/b100x100.txt
printf "\n\n"
...
mpiexec -n $procs ./openmpi ../resources/a1000x100.txt ../resources/b100x1000.txt
printf "\n\n"
...
mpiexec -n $procs ./openmpi ../resources/a1000x1000.txt ../resources/b1000x1000.txt
printf "\n\n"
